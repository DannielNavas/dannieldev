...
import { RepoListPipe } from '@shared/pipes/repo-list.pipe';
import { of } from 'rxjs';
...
describe('BlogResumenComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      providers: [{ provide: DevtoService, useClass: MockPostService }, {provide: RepoListPipe, useClass: MockRepoListPipe}],
    }).compileComponents();
  });
